...
create table web_returns (
                wr_return_date_sk        integer,
                wr_return_time_sk        integer,
...
create table income_band (
		...
		ib_lower_bound           integer, ib_upper_bound           integer)
-- HAMMERORA GO
...
create table dsdgen_version (
        dv_version               varchar(64) not null,
