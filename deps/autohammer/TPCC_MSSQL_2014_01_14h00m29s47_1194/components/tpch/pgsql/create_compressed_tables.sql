CREATE TABLE ORDERS (O_ORDERDATE TIMESTAMP, 
        ...
        $compression DISTRIBUTED BY (O_ORDERKEY)
-- HAMMERORA GO
CREATE TABLE PARTSUPP (PS_PARTKEY NUMERIC NOT NULL, 
          ...
          $compression DISTRIBUTED BY (PS_PARTKEY,PS_SUPPKEY)
-- HAMMERORA GO
CREATE TABLE CUSTOMER(C_CUSTKEY NUMERIC NOT NULL, 
         ...
         $compression DISTRIBUTED BY (C_CUSTKEY)
-- HAMMERORA GO
CREATE TABLE PART(P_PARTKEY NUMERIC NOT NULL, 
     ...
     $compression DISTRIBUTED BY (P_PARTKEY)
-- HAMMERORA GO
CREATE TABLE SUPPLIER(S_SUPPKEY NUMERIC NOT NULL, 
                      ...
                      S_PHONE CHAR(15), 
                      S_ACCTBAL NUMERIC)  
         $compression DISTRIBUTED BY (S_SUPPKEY) 
-- HAMMERORA GO
CREATE TABLE NATION(N_NATIONKEY NUMERIC NOT NULL, 
                    N_NAME CHAR(25), 
                    N_REGIONKEY NUMERIC, 
                    N_COMMENT VARCHAR(152)) 
       $compression DISTRIBUTED BY (N_NATIONKEY)
-- HAMMERORA GO
CREATE TABLE REGION(R_REGIONKEY NUMERIC, 
                    R_NAME CHAR(25), 
                    R_COMMENT VARCHAR(152)) 
       $compression DISTRIBUTED BY (R_REGIONKEY)
-- HAMMERORA GO
