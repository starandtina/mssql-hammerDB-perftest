...
SELECT 	d1.d_date_sk ws_sold_date_sk,
	...
	i_wholesale_cost * wlin_quantity ws_ext_list_price,
	...
	((wlin_sales_price * wlin_quantity)-wlin_coupon_amt)*(1+web_tax_percentage) ws_net_pain_inc_tax,
	...
	(wlin_sales_price * wlin_quantity)-wlin_coupon_amt + (wlin_ship_cost * wlin_quantity)
	   + i_current_price * web_tax_percentage ws_net_pain_inc_ship_tax,
